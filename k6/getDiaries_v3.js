...
export default function () {
    ...
    let loginRes = http.post('http://localhost:8080/api/v2/member/test/login', loginPayload, {
    ...
    for (let page = 0; page < totalPages; page++) {
        ...
        let diaryRes = http.get(`http://localhost:8080/api/v2/member/diary?page=${page}&size=${pageSize}`, { headers: diaryHeaders });
