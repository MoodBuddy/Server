...
SET j = 1;
        WHILE j <= 50 DO
            ...
            INSERT INTO diary (
                diary_title, diary_date, diary_content, diary_weather, diary_emotion,
                diary_status, diary_subject, diary_summary, user_id,
                diary_book_mark_check, diary_font, diary_font_size, created_time, updated_time
            ) VALUES (
                CONCAT('더미 제목_', j),
            ...
            WHILE k <= 10 DO
                ...
                INSERT INTO diary_image (
                    diary_id, diary_img_url, diary_image_status, diary_image_file_name,
                    diary_img_width, diary_img_height, diary_img_thumb_file_name, diary_img_thumb_url,
                    diary_img_thumb_width, diary_img_thumb_height, created_time, updated_time
                ) VALUES (
                    diary_id,
                    CONCAT('https://example.com/diary_image_', i, '_', j, '_', k, '.jpg'),
                    'ACTIVE',
                    CONCAT('file_', i, '_', j, '_', k, '.jpg'),
                    1920.0,
                    1080.0,
                    CONCAT('thumb_file_', i, '_', j, '_', k, '.jpg'),
                    CONCAT('https://example.com/thumb_', i, '_', j, '_', k, '.jpg'),
                    320.0,
                    180.0,
                    NOW(),
                    NOW()
