...
public class QDiaryImage extends EntityPathBase<DiaryImage> {
    ...
    private static final long serialVersionUID = -324245813L;
    ...
    public final EnumPath<DiaryImageStatus> diaryImageStatus = createEnum("diaryImageStatus", DiaryImageStatus.class);
