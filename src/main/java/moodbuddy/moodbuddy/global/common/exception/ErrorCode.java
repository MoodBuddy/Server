...
public enum ErrorCode {
    ...
    NOT_FOUND(404,"COMMON-ERR-400","PAGE NOT FOUND"),
    NOT_FOUND_DIARY(404, "DIARY-ERR-400", "일기를 찾을 수 없습니다."),
    NOT_FOUND_QUDDYTI(404, "QUDDYTI-ERR-400", "쿼디티아이를 찾을 수 없습니다."),
    NOT_FOUND_USER(404, "USER-ERR-400", "아이디에 해당하는 회원을 찾을 수 없습니다."),
